...
public class TwoBallLeftCommand extends SequentialCommandGroup {
    public TwoBallLeftCommand(DriveTrain driveTrain, Intake intake, Spinners spinners, Shooter shooter,
            LimeLight limeLight, Feeder feeder) {
        super(new IntakeDeployCommand(intake),
                race(new IntakeSpinnersRunCommand(intake, spinners),
                        TrajectoryCommandGenerator.getCommandFromFile("2BallLeftA", driveTrain)),
