...
public class TwoBallRightCommand extends SequentialCommandGroup {
    public TwoBallRightCommand(DriveTrain driveTrain, Intake intake, Spinners spinners, Shooter shooter,
            LimeLight limeLight, Feeder feeder) {
        super(new IntakeDeployCommand(intake),
                race(new IntakeSpinnersRunCommand(intake, spinners),
                        TrajectoryCommandGenerator.getCommandFromFile("2BallRightA", driveTrain)),
